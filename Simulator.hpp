...
public:
    ...
    void show_stats()
    {
        ...
        // FIXME: Calculate and display the average wait time for the landing queue //DONE
        
        double averageLandingWait = landing_queue->get_total_wait() / landing_queue->get_num_served();
        std::cout << "The average wait time (mins) was: " << averageLandingWait << std::endl;
        ...
        // FIXME: Calculate and display the average wait time for the departure queue //DONE
        double averageDepartureWait = departure_queue->get_total_wait() / departure_queue->get_num_served();
        std::cout << "The average wait time (mins) was: " << averageDepartureWait << std::endl;
